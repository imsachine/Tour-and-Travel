...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Jul 2022 06:46:32 GMT -->
<head>
	...
	<section>
		<div class="tr-register">
			<div class="tr-regi-form">
				...
				<form class="col s12" action='register_back.php' method="post">
					<div class="row">
                    ...
                    <div class="row">
						<div class="input-field col s12">
							<input type="text" class="validate" name='uid'>
					...
					<div class="row">
						<div class="input-field col s12">
							<input type="submit" value="submit"  name='submit' class="waves-effect waves-light btn-large full-btn"> </div>
					</div>
				</form>
				<!-- <p><a href="forgot-pass-2.html">forgot password</a> | Are you a new user ? <a href="register.html">Register</a>
				</p> -->
				<!-- <div class="soc-login">
					<h4>Sign in using</h4>
					<ul>
